...
parameters = {'model__boosting_type':['gbdt', 'dart', 'gross', 'rf'],
              }

# # Parameters for gridsearch
# parameters = {'model__learning_rate':(0.04, 0.05, 0.06),
#               'model__num_leaves':(110, 128, 140),
#               'model__feature_fraction':(0.6, 0.7, 0.8)}

# Gridsearch and fit
print('Gridsearch Start')
search = GridSearchCV(pipe, param_grid=parameters, cv=3, scoring='neg_mean_absolute_error', n_jobs=4)
